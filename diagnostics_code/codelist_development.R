...
aortic_valve_replacement_opcs4 <- c("K26.1","K26.2","K26.3","K26.4",
                                    ...
                                    "K26.8","K26.9")
tavi_opcs4 <- c("Y49.4", "Y79.1", "Y79.2", "Y79.3", "Y79.4", "Y79.5", "Y79.8", "Y79.9")
...
tavi <- list(
  tavi = opcs4_to_standard(tavi_opcs4)) |>
  omopgenerics::newCodelist()
...
write_xlsx(list("codes_for_review" = avd |>
                  mutate(aortic_valve_disease = NA_character_,
                         ...
                         mixed_aortic_alve_disease  = NA_character_),
                "read_code_mappings" = avd_read_mappings,
                "icd_code_mappings" = avd_icd_mappings),
