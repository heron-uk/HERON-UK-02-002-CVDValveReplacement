...
2)  Open the project <i>`congenital_study_code.Rproj`</i> from the StudyCode directory in RStudio (when inside the project, you will see its name on the top-right of your RStudio session)
