# Activity limitation
newCodelist(list("activity_limitation_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
...
# Arthritis
newCodelist(list("arthritis_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                              conceptId = c(4291025)))) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Cerebrovascular disease
newCodelist(list("cerebrovascular_disease_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                            conceptId = c(381591)))) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Dizziness
newCodelist(list("dizziness_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                              conceptId = c(4223938, 4297376)))) |>
...
# Dyspnea
newCodelist(list("dyspnea_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                            conceptId = c(4305080, 4041664)))) |>
  excludeConcepts(cdm = cdm_vocab_2025_08,
                  concepts = c(45772947, 42539560, 4318857, 258866)) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Falls
newCodelist(list("falls_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                          conceptId = c(4329906, 4256754, 4087528, 4224116)))) |>
  addConcepts(cdm = cdm_vocab_2025_08, concepts = c(4323345, 435991, 436583, 4184243)) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")


# Foot problem
newCodelist(list("foot_problem_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                 conceptId = c(4268887, 4053100, 4101512, 4136647, 
                                                               4138349, 4140790, 4140924, 42539590, 
                                                               4083436, 4139895, 4085778, 4139217,
                                                               4139218, 42539494, 4139705)))) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Hearing impairment
newCodelist(list("hearing_impairment_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
...
newCodelist(list("heart_valve_disorder_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                         conceptId = c(4281749)))) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")


# Housebound
newCodelist(list("housebound_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                               conceptId = c(40299189, 4052962, 45877743)))) |>
  addConcepts(cdm = cdm_vocab_2025_08, concepts = c(4022076, 4022523)) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Hypotension
newCodelist(list("hypotension_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
...
newCodelist(list("memory_and_cognitive_problems_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
...
newCodelist(list("mobility_and_transfer_problems_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                                   conceptId = c(4200353, 4199115,  4199721, 44790310, 45878557, 36716239,
                                                                                 ...
                                                                                 439405, 4023190, 4086557, 4200822)))) |>
  addConcepts(cdm = cdm_vocab_2025_08, concepts = c(4240470)) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Peptic ulcer
newCodelist(list("peptic_ulcer_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                                conceptId = c(4057060, 4134146, 4027663)))) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Peripheral vascular disease
newCodelist(list("peripheral_vascular_disease_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                                conceptId = c(321052)))) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Requirement for health
newCodelist(list("requirement_for_care_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                         conceptId = c(35609081, 4052486,  4192880, 44791364, 4074789, 4022081, 3661927, 44790305,
                                                                       ...
                                                                       44814152, 44814153, 4119866, 44804659, 4305680, 37310422, 4088536,37108723)))) |>
  excludeConcepts(cdm = cdm_vocab_2025_08,
  ...
  addConcepts(cdm = vocab_2025_08, concepts = c(44788849, 44807727,4081589,42535090)) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Skin ulcer
newCodelist(list("skin_ulcer_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                               conceptId = c(4262920,46269752, 46269755)))) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Sleep disorder
newCodelist(list("sleep_disorder_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                   conceptId = c(4086851,37110488,4115402,42689991,42689992,43530738,4204989,42690122,42690123,
                                                                 ...
                                                                 4305303,435524,40482260,40480927,4132137,42690379,42690380)))) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Social vulnerability
newCodelist(list("social_vulnerability_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
...
# Thyroid disease
newCodelist(list("thyroid_disease_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                    conceptId = c(141253, 4194160, 141253)))) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")

# Urinary incontinence
newCodelist(list("urinary_incontinence_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                         conceptId = c(4032498,4030763, 37208161,4302457, 606405,193598,195007, 45770268, 195079, 444035,
                                                                       ...
                                                                       42538538, 193326, 197672,37119132,45757352,4153667, 4172646, 4092642)))) |>
  exportCodelist(path = here("codelists", "efi_codelists"), type = "csv")


# Visual impairment
newCodelist(list("visual_impairment_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                      conceptId = c(374034,375545,435262,437541, 4265433,4334259, 44797518, 40305578, 4023310,
                                                                    375545,4265433,42872584)))) |>
  excludeConcepts(cdm = cdm_vocab_2025_08,
                  concepts = c(44790749,
...
newCodelist(list("weight_loss_and_anorexia_not_reviewed" = getDescendants(cdm_vocab_2025_08, 
                                                             conceptId = c(436675,44784528,4269485,4300305,4091029,4333683, 134765,4109384,763515,44788734,
                                                                           ...
                                                                           4031170, 4078430, 4031171, 4123542, 4229881)))) |>
